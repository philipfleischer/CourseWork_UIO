...
class Innlevering2Runner {
    ...
    //static final Sorter[] ALGS1 = { new Selection() , new Insertion(), new Quick(), new Merge() };
    static final Sorter[] ALGS1 = { new Merge() };
    // Put the sorting algorithms under test for part 2 here
    //static final Sorter[] ALGS2 = { new Selection() , new Insertion(), new Quick(), new Merge() };
    static final Sorter[] ALGS2 = { new Merge() };
